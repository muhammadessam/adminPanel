...
@section('content')
    <div class="pt-3 container">
        <h4 class="col-12">{{trans('branch.create_header')}}</h4>
        @if($errors->any())
        ...
        @endif
        <form action="{{route('admin.brenchs.store')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="manger_phone" id="manger_phone">
                    </div>
                </div>
                <div class="col-4">
                    <div class="form-group">
                ...
                <div class="col-4">
                    ...
                    <button class="btn btn-block btn-outline-success" type="submit">{{__('branch.create')}}</button>
                </div>
            </div>
        </form>
    </div>
